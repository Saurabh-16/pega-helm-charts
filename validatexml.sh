if xmllint --noout charts/pega/config/deploy/context.xml.tmpl > /dev/null 2>&1;
then
...
if xmllint --noout charts/pega/config/deploy/server.xml.tmpl > /dev/null 2>&1;
then
...
if xmllint --noout charts/pega/config/deploy/prconfig.xml > /dev/null 2>&1;
then
...
if xmllint --noout charts/pega/config/deploy/prlog4j2.xml > /dev/null 2>&1;
then
...
if xmllint --noout charts/pega/charts/installer/config/prlog4j2.xml > /dev/null 2>&1;
then
...
if xmllint --noout charts/pega/charts/installer/config/prconfig.xml.tmpl > /dev/null 2>&1;
then
